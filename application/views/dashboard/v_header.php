...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/assets/css/plugins.min.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/assets/css/kaiadmin.min.css" />
        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            <a href="index.html" class="logo">
              <img
                src="<?php echo base_url(); ?>assets/admin/assets/img/kaiadmin/logo_light.svg"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
              ...
              <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                  ...
                  >
                    <div class="avatar-sm">
                      <img
                        src="<?php echo base_url(); ?>assets/admin/assets/img/profile.jpg"
                        alt="..."
