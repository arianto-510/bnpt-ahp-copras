...
<head>
  ...
  <title>Dashboard | AHP-COPRAS</title>
  <meta content="width=device-width, initial-scale=1.0, shrink-to-fit=no" name="viewport" />
  <link rel="icon" href="" href="<?php echo base_url(); ?>assets/assets/img/kaiadmin/favicon.ico" type="image/x-icon" />
  <script src="<?php echo base_url(); ?>assets/assets/js/core/jquery-3.7.1.min.js"></script>

  <!-- Fonts and icons -->
  <script src="" href="<?php echo base_url(); ?>assets/assets/js/plugin/webfont/webfont.min.js"></script>
  <script>
    WebFont.load({
      google: {
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/css/plugins.min.css" />
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/assets/css/kaiadmin.min.css" />
      ...
      <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="dark">
          <a href="<?= base_url() ?>" class="logo">
            <h2 class="text-white">SPK BPNT</h2>
            <!-- <img src="<?php echo base_url(); ?>assets/assets/img/kaiadmin/logo_light.svg" alt="navbar brand" class="navbar-brand" height="20" /> -->
          </a>
