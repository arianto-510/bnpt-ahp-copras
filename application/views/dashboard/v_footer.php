...
<footer class="footer">
    ...
    <!-- jQuery Vector Maps -->
    <script src="<?php echo base_url(); ?>assets/admin/assets/js/plugin/jsvectormap/jsvectormap.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/admin/assets/js/plugin/jsvectormap/world.js"></script>

    <!-- Sweet Alert -->
    <script src="<?php echo base_url(); ?>assets/admin/assets/js/plugin/sweetalert/sweetalert.min.js"></script>

    <!-- Kaiadmin JS -->
    <script src="<?php echo base_url(); ?>assets/admin/assets/js/kaiadmin.min.js"></script>
