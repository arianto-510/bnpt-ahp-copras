                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-1">
                            ...
                            // Tambahkan rangking
                            $verifikasi = 'bukan penerima';
                            $rangking   = 1;
                            $batas      = $pengumuman->jum_target;
                            foreach ($hasil_akhir as $hasil) :
                              if ($pengumuman->nik == $hasil->nik) {
                                if ($rangking <= $batas) {
                                  // $verifikasi = 'penerima';
                                  $verifikasi = $hasil->status;
                                  break;
                                }
                              }
                              $rangking++;
                            ...
                            <?php if ($verifikasi == 1) : ?>
                              ...
                              <div class='alert alert-dismissible text-white' role='alert' style="background-color: #54B435;">
                                  <div>
                                      <h3 class="text-white" style="line-height: 130%;">Anda Masuk Dalam Penerima Manfaat Bantuan Pangan Non Tunai (BPNT) !</h3>
                                  </div>
                              </div>
                            ...
                            <?php elseif($verifikasi == 2) : ?>
                              ...
                              <div class='alert alert-dismissible text-white' role='alert' style="background-color: #FF0000;">
                                  <div>
                                      <h3 class="text-white" style="line-height: 130%;">Maaf, Anda Tidak Masuk Dalam Penerima Manfaat Bantuan Pangan Non Tunai (BPNT) !</h3>
                                  </div>
                              </div>
                            <?php endif; ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" class="py-3">
                                                            <p class="mb-0">
                                                                ...
                                                                <h1>
                                                                    <strong><?= $pengumuman->nama_warga; ?></strong>
                                                                </h1>
                                                            </p>
                                                        </td>
                                                    </tr>
                                        ...
                                        <div class="mb-3 col-md-8">
                                            ...
                                            <div class=' mt-3 alert alert-info alert-dismissible' role='alert'>
                                                <p class="text-black">
                                                    ...
                                                    <!-- lolos -->
                                                      <strong>
                                                        Anda Masuk Dalam Penerima Manfaat Bantuan Pangan Non Tunai (BPNT) Dinas Sosial Kab. Buton Tengah!
                                                      </strong>

                                                    <?php elseif($verifikasi == 2) : ?>
                                                    <!-- tidak lolos -->
                                                      <strong>
                                                        Maaf, Anda Tidak Masuk Dalam Penerima Manfaat Bantuan Pangan Non Tunai (BPNT) Dinas Sosial Kab. Buton Tengah!
                                                      </strong>
                                                    <?php endif; ?>
                                                    <br>
